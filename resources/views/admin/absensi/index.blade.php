    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="alert alert-info">
                Menampilkan rekap absensi bulan: <strong
                    id="periodeInfo">{{ \Carbon\Carbon::create()->month((int) $bulan)->translatedFormat('F') }}
                    {{ $tahun }}</strong>.
                Form di bawah adalah untuk input kehadiran hari ini:
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchData() {
                ...
                let url = "{{ route('absensi.index') }}?bulan=" + bulan + "&tahun=" + tahun + "&search=" +
                    search_term;
