...
<head>
    <meta charset="UTF-8">
    <title>Slip Gaji - {{ $slipData->karyawan->nama_lengkap }} -
        {{ \Carbon\Carbon::create()->month((int) $slipData->bulan)->translatedFormat('F') }} {{ $slipData->tahun }}
    </title>
    <style>
            ...
            <div class="penerimaan">
                <table class="summary-table">
                    ...
                    <tbody>
                        <tr>
                            <td>Gaji Pokok</td>
                            <td>Rp {{ number_format($slipData->gaji_pokok, 0, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td>Tunjangan Transport</td>
                            <td>Rp {{ number_format($slipData->tunjangan_transport, 0, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td>Uang Makan</td>
                    ...
                    <tbody>
                        ...
                        @if ($slipData->potongan_alpha->total > 0)
                            <tr>
                                ...
                                <td class="text-danger">- Rp
                                    {{ number_format($slipData->potongan_alpha->total, 0, ',', '.') }}</td>
                            </tr>
                        @endif
                        @foreach ($slipData->rincian_potongan_lainnya as $potongan)
                            <tr>
                                <td>{{ $potongan->jenis_potongan }}</td>
                                <td class="text-danger">- Rp {{ number_format($potongan->jumlah, 0, ',', '.') }}</td>
                            </tr>
                        @endforeach
                        <tr class="total-row">
