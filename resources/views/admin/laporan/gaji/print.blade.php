...
<head>
    <meta charset="UTF-8">
    <title>Laporan Gaji Karyawan - {{ \Carbon\Carbon::create()->month((int) $bulan)->translatedFormat('F') }}
        {{ $tahun }}
    </title>
    <style>
...
<body onload="window.print()">
    ...
    <div class="container">
        <div class="header">
            ...
            <p><strong>PT. Teddy Corp</strong></p>
            <p>Periode: {{ \Carbon\Carbon::create()->month((int) $bulan)->translatedFormat('F') }} {{ $tahun }}
            </p>
        </div>
        ...
        <div class="signature">
            <p class="date">Kota Surabaya, {{ \Carbon\Carbon::now()->translatedFormat('d F Y') }}</p>
